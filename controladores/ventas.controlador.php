 ...
 */
			...
			$impresora = "RPT-008";
				...
				$imprimir-> text("MESA DEL NORTE #235."."\n");

				$imprimir-> text("COL.BELISARIO DOMINGUEZ". "\n");

				$imprimir-> text("GUADALAJARA,JAL.". "\n");

				$imprimir-> text("TEL: 26-27-52-25". "\n");

				$imprimir-> text("RFC: PAGS980822BE1"."\n");

				$imprimir->text(date("Y-m-d h:i:s")."\n");

				$imprimir-> feed(1);

				$imprimir->text("FACTURA N.".$_POST["nuevaVenta"]."\n");
				...
				$imprimir->text("VENDEDOR: ".$traerVendedor["nombre"]."\n");

				$imprimir-> feed(1);

				$imprimir-> text("PRODUCTOS:"."\n");
